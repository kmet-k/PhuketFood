...
$(document).ready(function(){
    ...
    if(menu.length==0){
        ...
        menu.forEach((item,value) => {
            ...
            var object = `<div class="col col-3" style="margin-top:2%;" onClick="createModal('${item[0]}','${item[1]}','${item[2]}','${item[3]}','${item[4]}','${item[5]}','${item[7]}')" data-toggle="modal" data-target="#showModal">
...
function createModal(name,name_2,name_3,meat,type,rec,pic){
    ...
    image=pic
    console.log(image)
    $("#imgModal").css("background-image", 'url('+image+')');
